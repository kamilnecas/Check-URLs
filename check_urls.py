...
def split_merged_urls(urls_p, regex_p):
    ...
    :param regex_p: Regular expression is provided/written in method 'perform_split_merged_urls(urls_p)'.
    """
...
def perform_split_merged_urls(urls_p):
    """
    It performs splitting of merged URLs. It calls method 'split_merged_urls(urls_p, regex_p)'.
    :param urls_p: List of URLs.
    """
...
def load_urls():
    ...
    Methods 'perform_split_merged_urls(urls)' and 'check_add_schema(urls)' are called.
